...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *CoreDocker.Api.Lambda*):

Restore dependencies
```
    cd "CoreDocker.Api.Lambda"
    dotnet restore
```

Execute unit tests
```
    cd "CoreDocker.Api.Lambda/test/CoreDocker.Api.Lambda.Tests"
    dotnet test
```

Deploy application
```
    cd "CoreDocker.Api.Lambda/src/CoreDocker.Api.Lambda"
