...
namespace CoreDocker.Utilities.Helpers
{
    public static class DictionaryHelper
    {
        ...
        public static TValue GetOrAdd<TKey, TValue>(this IDictionary<TKey,TValue> contextContextData, TKey key, Func<TValue> value)
        {
            ...
            else
            {
                ...
                {
                    if (contextContextData.TryGetValue(key, out var result1))
                    {
                        return result1;
                    }
                    var value1 = value();
