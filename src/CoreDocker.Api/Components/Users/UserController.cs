...
namespace CoreDocker.Api.Components.Users
{
    ...
    public class UserController : Controller, IUserControllerActions,
        IBaseControllerLookups<UserModel, UserReferenceModel>
    {
        ...
        #region IBaseControllerLookups<UserModel,UserReferenceModel> Members
        ...
        /// </returns>
        [HttpGet]
        [AuthorizeActivity(Activity.ReadUsers)]
        ...
        [AuthorizeActivity(Activity.UpdateUsers)]
        ...
        [AuthorizeActivity(Activity.DeleteUser)]
        ...
        [HttpGet(RouteHelper.UserControllerRoles)]
        [AuthorizeActivity(Activity.ReadUsers)]
        ...
        /// <returns></returns>
        [HttpPost(RouteHelper.UserControllerRegister)]
        [AllowAnonymous]
        ...
        /// <returns></returns>
        [HttpGet(RouteHelper.UserControllerForgotPassword)]
        [AllowAnonymous]
        ...
        /// <returns>
        /// </returns>
        [HttpGet(RouteHelper.UserControllerWhoAmI)]
        [AuthorizeActivity]
